...
<div class="level3">
  <dl>
    ...
    <dd>[[<?php echo hsc(getID()); ?>|<?php tpl_pagetitle(); ?>]] ([[<?php echo hsc(getID()."?rev=".$rev); ?>|<?php echo hsc($lang["monobook_cite_thisversion"]); ?>]])</dd>
  </dl>
  <dl>
    <dt><?php echo hsc($lang["monobook_cite_result"]); ?></dt>
    <dd><a rel="nofollow" class="wikilink1" href="<?php echo hsc(wl(cleanID(getId()))); ?>"><?php tpl_pagetitle(); ?></a> (<a rel="nofollow" class="wikilink1" href="<?php echo hsc($permurl); ?>"><?php echo hsc($lang["monobook_cite_thisversion"]); ?></a>)</dd>
  </dl>
</div>
