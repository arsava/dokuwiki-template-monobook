...
$lang["monobook_sitenotice_translate"] = "만약 보여주고 <a href=\"https://www.dokuwiki.org/plugin:translation\">Translation 플러그인</a>을 사용할 수 있다면: 언어별 사이트 넓은 알림을 불러올까요?<br />번역된 사이트 알림의 위키 문서는 ['monobook_sitenotice_location'의 값]_[iso 언어 코드] (예를 들어 ':wiki:site_notice_de') 입니다.";

//navigation
$lang["monobook_navigation"]           = "둘러보기를 보여줄까요?";
$lang["monobook_navigation_location"]  = "만약 보여준다면 둘러보기로 다음 위키 문서 사용:";
$lang["monobook_navigation_translate"] = "만약 보여주고 <a href=\"https://www.dokuwiki.org/plugin:translation\">Translation 플러그인</a>을 사용할 수 있다면: 언어별 둘러보기를 불러올까요?<br />번역된 둘러보기의 위키 문서는 ['monobook_navigation_location'의 값]_[iso 언어 코드] (예를 들어 ':wiki:navigation_de') 입니다.";
...
$lang["monobook_copyright_translate"] = "만약 보여주고 <a href=\"https://www.dokuwiki.org/plugin:translation\">Translation 플러그인</a>을 사용할 수 있다면: 언어별 저작권 알림을 불러올까요?<br />번역된 저작권 일림의 위키 문서는 ['monobook_copyright_location'의 값]_[iso 언어 코드] (예를 들어 ':wiki:copyright_de') 입니다.";

//search form
$lang["monobook_search"] = "검색 양식을 보여줄까요?";

//toolbox
$lang["monobook_toolbox"]               = "도구를 보여줄까요?";
$lang["monobook_toolbox_default"]       = "만약 보여준다면 기본 도구를 사용하겠습니까?";
$lang["monobook_toolbox_default_print"] = "만약 기본 도구를 사용한다면 인쇄용 문서 링크를 보여줄까요?";
$lang["monobook_toolbox_location"]      = "기본 모음을 사용하지 않는다면 도구 위치로 다음 위키 문서 사용:";
